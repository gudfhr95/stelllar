...
export class Migration20221105142009 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "server" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "name" text not null, "display_name" text not null, "description" text null, "owner_id" bigint not null, "category" text check ("category" in (\'Arts\', \'Business\', \'Culture\', \'Discussion\', \'Entertainment\', \'Gaming\', \'Health\', \'Hobbies\', \'Lifestyle\', \'Memes\', \'Meta\', \'News\', \'Politics\', \'Programming\', \'Science\', \'Sports\', \'Technology\', \'Other\')) not null, "user_count" int4 not null, "avatar_url" text null, "banner_url" text null, "is_banned" bool not null, "is_deleted" bool not null, "is_public" bool not null, "is_chat_enabled" bool not null, "is_downvotes_enabled" bool not null, "is_featured" bool not null);');
    ...
    this.addSql('create table "channel" ("id" bigserial primary key, "created_at" timestamptz(0) not null, "name" text null, "description" text null, "server_id" bigint not null, "position" text not null, "type" text check ("type" in (\'Public\', \'Restricted\', \'Private\')) not null, "is_deleted" bool not null, "last_message_at" timestamptz(0) not null, "is_default" bool not null default false);');
