...
import { Dispatch, PropsWithChildren, useCallback, useEffect } from "react";
import {
  IconFormatBold,
  IconFormatCodeBlock,
...
export default function Editor({ text, setText }: Editor) {
...
function FormatGroup({ children }: PropsWithChildren) {
